...
import type { SocialSVGProps } from '../../types';

const LinkedIn = (props: SocialSVGProps) => (
  <svg width={22} height={22} viewBox="0 0 21 20" {...props}>
...
export default StyledSVG.withComponent(LinkedIn);
